    ...
    <>
      <style>{`
        ...
        #services::before {
          ...
          pointer-events: none;
          background:
            radial-gradient(circle at 8% 8%, rgba(125, 211, 252, .20), transparent 45%),
            radial-gradient(circle at 92% 12%, rgba(134, 239, 172, .18), transparent 42%),
            radial-gradient(circle at 50% 90%, rgba(255, 255, 255, .38), transparent 52%);
          filter: blur(8px);
        }
